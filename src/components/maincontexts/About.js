                    ...
                    <div className="about-city">
                        ...
                        <div className="about-text line">
                            <div className="about-para">
                                해당 브랜드의 조명이 위치하는 가상의 공간을 구성했다. 공간을 이루는 요소를 다섯 가지 조형으로 정의 내렸다. 기둥, 계단, 문, 벽 그리고 조명. 각각의 공간은 브랜드에 기반이 되는 조명과 공간에 기반이 되는 벽을 제외한 기둥, 계단, 문이 특징적으로 반영돼 디자인된 공간이다. _기하은
                            </div>
